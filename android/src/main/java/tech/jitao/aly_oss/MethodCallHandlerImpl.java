...
//        };
        ...
        ((OSSAuthCredentialsProvider) credentialProvider).setDecoder(new OSSAuthCredentialsProvider.AuthDecoder() {
            @Override
        ...
        conf.setConnectionTimeout(90 * 1000); // 连接超时时间，默认15秒
        conf.setSocketTimeout(90 * 1000); // Socket超时时间，默认15秒
